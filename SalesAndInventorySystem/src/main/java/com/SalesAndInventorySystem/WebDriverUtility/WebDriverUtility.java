package com.SalesAndInventorySystem.WebDriverUtility;
...
public class WebDriverUtility {
	...
	public void validateUsingHardAsserttrue(String actData,String passedData) {
	...
	public void validateUsingHardAsset(String actData,String passedData)
	{
		
		Assert.assertEquals(actData, passedData);
